...
# 6. modules
# 기능의 집합
# 따로 설치할 필요없이 프로그램에 import해서 사용할 수 있음

import math  # math의 함수 중 사용하지 않는 기능까지 전부 가져오기 때문에 비효율적
             # 사용할 math함수 앞에 math 표기 O

print(math.ceil(1.2))  # 반올림   
print(math.fabs(-1.2)) # 절댓값 
print(math.fsum[1, 2, 3, 4, 5]) # 총합


from math import ceil, fabs, fsum   # 사용할 함수만 import
                                    # 사용할 math함수 앞에 math 표기 X
print(ceil(1.2))   
print(fabs(-1.2))
...
from math import fsum as nice_sum  #  사용할 함수명 임의로 지정 가능

print(nice_sum([1, 2, 3, 4, 5])) 




# 다른 파일에 정의해놓은 함수도 사용 가능
# .py 생략해서 사용

from calculator import plus_fun  # calculator.py에 정의해놓은 plus_fun함수 import  


print(plus_fun(3, 5))  # 8
